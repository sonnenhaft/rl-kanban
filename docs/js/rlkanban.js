...
.constant('scripts', {"start":"gulp serve","build":"gulp build"})
.constant('homepage', "http://rl-kanban.bitballoon.com/#?layout=work-tracker&contentLevel=maximum")
.constant('devDependencies', {"angular":"1.3.2","angular-resource":"1.3.2","angular-sanitize":"1.3.2","angular-animate":"1.3.2","angular-touch":"1.3.2","commander":"^2.6.0","gulp":"~3.9.0","gulp-angular-templatecache":"~1.5.0","gulp-autoprefixer":"~2.1.0","gulp-clean":"~0.3.1","gulp-clone":"~1.0.0","gulp-connect":"~2.2.0","gulp-copy":"0.0.2","gulp-css-url-adjuster":"~0.2.3","gulp-inject":"~1.0.2","gulp-jshint":"~1.9.0","gulp-jshint-xml-file-reporter":"^0.5.1","gulp-livereload":"~3.2.0","gulp-minify-css":"~0.3.11","gulp-minify-html":"~0.1.7","gulp-ng-annotate":"~0.4.3","gulp-ng-config":"~1.0.0","gulp-nightwatch":"^0.2.6","gulp-notify":"^2.2.0","gulp-open":"~0.2.8","gulp-processhtml":"^1.0.2","gulp-protractor":"^1.0.0","gulp-rename":"~1.2.0","gulp-sass":"2.1.0","gulp-sourcemaps":"~1.2.8","gulp-uglify":"~1.0.2","gulp-usemin":"~0.3.8","gulp-util":"^3.0.4","gulp-ver":"~0.1.0","jasmine-reporters":"^2.0.7","jshint-stylish":"~1.0.0","karma":"~0.12.24","karma-chrome-launcher":"~0.1.2","karma-coverage":"~0.2.7","karma-jasmine":"~0.2.3","karma-js-coverage":"~0.2.0","karma-junit-reporter":"^0.3.8","karma-ng-html2js-preprocessor":"~0.1.0","karma-ng-json2js-preprocessor":"^1.1.1","karma-phantomjs-launcher":"~0.1.2","phantomjs":"~1.9.15","protractor":"^3.0.0","run-sequence":"~1.0.2","underscore":"1.7.0"})

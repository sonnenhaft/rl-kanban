module.exports = {
    'checking cards drag and drop': function (browser) {
        browser
            ...
            .mouseButtonDown(0)
            .moveToElement('kanban-column:nth-child(1)', 20, 250)
            .moveToElement('kanban-column:nth-child(3)', 20, 250)
            .moveToElement('kanban-column:nth-child(4)', 20, 250)
            .mouseButtonUp(0)
    ...
    'card should not be dropped into dissalowed column': function (browser) {
        browser
            ...
            .moveToElement('kanban-column:nth-child(3)', 20, 250)
            .moveToElement('kanban-column:nth-child(4)', 20, 250)
            .moveToElement('kanban-column:nth-child(5)', 20, 250)
            .mouseButtonUp(0)
            .assert.elementPresent('swim-lane:nth-child(2)  kanban-column:nth-child(1)  kanban-card')
            .end();
    }

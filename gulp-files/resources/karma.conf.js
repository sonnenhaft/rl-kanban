module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'gulp-files/resources/directive-builder.js',
            'gulp-files/resources/package-version/*.js',
            'gulp-files/resources/package-version/test/*.js',
        ...
        preprocessors: {
            '{app,app/!(vendor|sc-deps|demo-code)+(**)/**}/!(*data|*spec)+(.js)': ['coverage'],
            'app/**/*.html': ['ng-html2js'],
            '**/*.json': ['ng-json2js']
        },
